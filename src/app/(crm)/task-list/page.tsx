...
type Task = { id: number; title: string; status: Status; tag?: string; due: string; comments: number; avatar: string };
const seed: Task[] = [
...
export default function TaskListPage() {
  ...
  const toggle = (id: number) => setTasks(items => items.map(task => task.id === id ? { ...task, status: task.status === "Completed" ? "Todo" : "Completed" } : task));
