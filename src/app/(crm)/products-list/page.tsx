...
export default function ProductsListPage() {
  ...
  return <div className="space-y-4">
    ...
    <div className="flex flex-col gap-4 px-5 py-4 sm:flex-row sm:items-center sm:justify-between sm:px-6">
      ...
      <div className="flex gap-3"><button className="btn products-list-action h-11 border border-[var(--border)] bg-[var(--panel)] px-4" onClick={exportProducts}><Download size={17}/>Export</button><Link href="/add-product" className="btn btn-primary products-list-action h-11 px-4"><Plus size={17}/>Add Product</Link></div>
    </div>
