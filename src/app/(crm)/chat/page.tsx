...
export default function ChatPage() {
  ...
  const [active, setActive] = useState(contacts[1] ?? contacts[0]), [query, setQuery] = useState(""), [text, setText] = useState(""), [messages, setMessages] = useState(initialMessages), [mobileChat, setMobileChat] = useState(false), [menu, setMenu] = useState(false);
