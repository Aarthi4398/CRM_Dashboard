...
export interface CalendarEvent { id:string; title:string; date:string; time:string; category:"Meeting"|"Deadline"|"Call"; attendees:number; relatedTo:string; relatedToId?:string }
